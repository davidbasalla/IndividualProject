...
The Xvolume is a type of Xobject and inherits a host of attributes and functions from it. As it is an object, it can be added to a renderer. It has a file attribute and a labelmap attribute
...
A host of improvements could be added to make the application more useful and user-friendly.
